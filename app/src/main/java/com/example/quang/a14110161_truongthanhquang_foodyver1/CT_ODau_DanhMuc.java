...
public class CT_ODau_DanhMuc extends BaseAdapter {
    String[] result;
    Context context;
    int[] imageId;
     ...
     */
    public CT_ODau_DanhMuc(Context context, String[] result, int[] imageId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View rowView;
        com.example.quang.a14110161_truongthanhquang_foodyver1.CT_ODau_DanhMuc.Holder holder= new com.example.quang.a14110161_truongthanhquang_foodyver1.CT_ODau_DanhMuc.Holder();
