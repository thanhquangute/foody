...
public class CT_ODau_Adapter extends BaseAdapter{
    String[] result;
    Context context;
    int[] imageId;
     ...
     */
    public CT_ODau_Adapter(Context context, String[] result, int[] imageId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View rowView;
        CT_ODau_Adapter.Holder holder= new CT_ODau_Adapter.Holder();
