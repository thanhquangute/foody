...
public class CT_GridView_Adapter  extends BaseAdapter {
     ...
     */
    public CT_GridView_Adapter(Context context, String[] result, int[] imageId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View rowView;
        CT_GridView_Adapter.Holder holder= new CT_GridView_Adapter.Holder();
        rowView = inflater.inflate(R.layout.gridview, null);
        holder.textView = (TextView) rowView.findViewById(R.id.textgridview);
        holder.imageView = (ImageView) rowView.findViewById(R.id.imagridview);
