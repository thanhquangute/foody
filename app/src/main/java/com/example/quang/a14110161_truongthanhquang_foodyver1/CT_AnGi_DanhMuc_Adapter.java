...
public class CT_AnGi_DanhMuc_Adapter extends BaseAdapter {
        String[] result;
        Context context;
        int[] imageId;
         ...
         */
        public CT_AnGi_DanhMuc_Adapter(Context context, String[] result, int[] imageId) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            View rowView;
            com.example.quang.a14110161_truongthanhquang_foodyver1.CT_AnGi_DanhMuc_Adapter.Holder holder= new com.example.quang.a14110161_truongthanhquang_foodyver1.CT_AnGi_DanhMuc_Adapter.Holder();
            rowView = inflater.inflate(R.layout.listview_odau_new, null);
