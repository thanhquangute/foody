...
public class Home_AnGi_DanhMuc extends Fragment {
    ...
    public static   String[] tvNoiDung = {"Việt Nam", "Châu Mỹ","Mỹ","Tây Âu","Ý","Pháp","Đức","Tây Ban Nha","Trung Hoa","Ấn Độ","Thái Lan","Nhật Bản","Hàn Quốc","Malaysia","Quốc Tế","Sang Trọng","Buffet","Nhà hàng","Ăn vặt/vỉa hè","Ăn chay","Café/Dessert","Quán ăn","Bar/pub","Quán nhậu","Beer club","Tiệm bánh","Tiệc tận nơi","Shop Online","Giao cơm văn phòng","Khu ẩm thực"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.home_angi_danhmuc, container, false);
        lvCustomListView = (ListView) v.findViewById(R.id.ListViewAnGi_DanhMuc);
...
//        //lvCustomListView.setAdapter(adapter);
        ...
        lvCustomListView.setAdapter(new CT_AnGi_DanhMuc_Adapter(getActivity(), tvNoiDung, imgAvatar));
        return v;
