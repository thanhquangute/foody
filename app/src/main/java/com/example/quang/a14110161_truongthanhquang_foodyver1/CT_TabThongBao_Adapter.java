...
/**
 * Created by My PC on 3/21/2017.
 */

public class CT_TabThongBao_Adapter extends BaseAdapter {
    String[] result;
    Context context;
    int[] imageId;
     ...
     */
    public CT_TabThongBao_Adapter(Context context, String[] result, int[] imageId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View rowView;
        CT_TabThongBao_Adapter.Holder holder= new CT_TabThongBao_Adapter.Holder();
